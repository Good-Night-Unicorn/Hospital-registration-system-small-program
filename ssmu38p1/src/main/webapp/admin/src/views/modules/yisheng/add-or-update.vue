<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医生性别" prop="yishengxingbie">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生邮箱" prop="yishengyouxiang">
          <el-input v-model="ruleForm.yishengyouxiang" 
              placeholder="医生邮箱" clearable  :readonly="ro.yishengyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生邮箱" prop="yishengyouxiang">
              <el-input v-model="ruleForm.yishengyouxiang" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='yishengyouxiang'){
            this.ruleForm.yishengyouxiang = obj[o];
	    this.ro.yishengyouxiang = true;
            continue;
          }
