<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所属科室" prop="suoshukeshi">
          <el-select v-model="ruleForm.suoshukeshi" placeholder="请选择所属科室">
            <el-option
                v-for="(item,index) in suoshukeshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="所属科室" prop="suoshukeshi">
	      <el-input v-model="ruleForm.suoshukeshi"
                placeholder="所属科室" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生性别" prop="yishengxingbie">
          <el-input v-model="ruleForm.yishengxingbie" 
              placeholder="医生性别" clearable  :readonly="ro.yishengxingbie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生性别" prop="yishengxingbie">
              <el-input v-model="ruleForm.yishengxingbie" 
                placeholder="医生性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生年龄" prop="yishengnianling">
          <el-input v-model="ruleForm.yishengnianling" 
              placeholder="医生年龄" clearable  :readonly="ro.yishengnianling"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生年龄" prop="yishengnianling">
              <el-input v-model="ruleForm.yishengnianling" 
                placeholder="医生年龄" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院名字" prop="yiyuanmingzi">
          <el-input v-model="ruleForm.yiyuanmingzi" 
              placeholder="医院名字" clearable  :readonly="ro.yiyuanmingzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医院名字" prop="yiyuanmingzi">
              <el-input v-model="ruleForm.yiyuanmingzi" 
                placeholder="医院名字" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="门诊时间" prop="menzhenshijian">
          <el-input v-model="ruleForm.menzhenshijian" 
              placeholder="门诊时间" clearable  :readonly="ro.menzhenshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="门诊时间" prop="menzhenshijian">
              <el-input v-model="ruleForm.menzhenshijian" 
                placeholder="门诊时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yishengzhaopian" label="医生照片" prop="yishengzhaopian">
          <file-upload
          tip="点击上传医生照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yishengzhaopian" label="医生照片" prop="yishengzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yishengzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.yishengxingbie!=''&&json.yishengxingbie){
              		this.ruleForm.yishengxingbie = json.yishengxingbie
		}
		if(json.yishengnianling!=''&&json.yishengnianling){
              		this.ruleForm.yishengnianling = json.yishengnianling
		}
		if(json.lianxidianhua!=''&&json.lianxidianhua){
              		this.ruleForm.lianxidianhua = json.lianxidianhua
		}
		if(json.yiyuanmingzi!=''&&json.yiyuanmingzi){
              		this.ruleForm.yiyuanmingzi = json.yiyuanmingzi
		}
        } else {
	...
	this.ruleForm.yishengjianjie = this.ruleForm.yishengjianjie.replace(reg,'../../../ssmu38p1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhuanjiaxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhuanjiaxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
