...
public class HuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HuanzheEntity user = huanzheService.selectOne(new EntityWrapper<HuanzheEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody HuanzheEntity huanzhe){
    	...
    	HuanzheEntity user = huanzheService.selectOne(new EntityWrapper<HuanzheEntity>().eq("yonghuming", huanzhe.getYonghuming()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HuanzheEntity huanzhe, HttpServletRequest request){
        EntityWrapper<HuanzheEntity> ew = new EntityWrapper<HuanzheEntity>();
		PageUtils page = huanzheService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, huanzhe), params), params));
        return R.ok().put("data", page);
    }
